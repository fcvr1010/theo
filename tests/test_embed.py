"""Tests for theo._shared.embed (integration -- requires model download)."""
...
class TestEmbedText:
    ...
    def test_embed_single_text(self) -> None:
        from theo._shared._schema import EMBEDDING_DIM
    ...
    def test_reset_model(self) -> None:
        from theo._shared.embed import embed_text, reset_model

        embed_text(["trigger load"])
        reset_model()
        from theo._shared import embed as et_mod
