...
AGENTS_MD_SECTION = (
    ...
    "codebase intelligence. Finally, ask yourself: did I learn something new about "
    "the code in this session? Something non-trivial that I'd like to remember in the "
    "future? If yes, register it in theo, using the notes field of the relevant node or edge.\n"
)
